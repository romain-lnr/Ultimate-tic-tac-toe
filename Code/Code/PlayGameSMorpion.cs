...
namespace Code
{
    public partial class PlayGameSMorpionForm : Form
    {
        ...
        private void BotPlays(Label[,,,] labels)
        {
            ...
            } while (isOccupiedBy[rdmCaseColumn, rdmCaseRow, rdmColumn, rdmRow] != 0);

            PlaceSymbol(rdmCaseColumn, rdmCaseRow, rdmColumn, rdmRow, caches[rdmColumn, rdmRow], labels[rdmCaseColumn, rdmCaseRow, rdmColumn, rdmRow]);
        }
                    ...
                    if (result != 0)
                    {
                        ...
                        if (result == 1)
                        {
                            ...
                            for (int i = 0; i < 3; i++)
                            {
                                for (int j = 0; j < 3; j++)
                                {
                                    isOccupiedBy[idLabelCaseColumn, idLabelRow, i, j] = 3;
                                }
                            }
                        }
                        else if (result == 2)
                        {
                            ...
                            for (int i = 0; i < 3; i++)
                            {
                                for (int j = 0; j < 3; j++)
                                {
                                    isOccupiedBy[idLabelCaseColumn, idLabelRow, i, j] = 4;
                                }
                            }
                        }
                    }
